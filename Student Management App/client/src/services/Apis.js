...
export const usergetfunc = async(search,gender,semester,sort,page)=>{
    return await commonrequest("GET",`${BASE_URL}/user/details?search=${search}&gender=${gender}&semester=${semester}&sort=${sort}&page=${page}`,"");
}
